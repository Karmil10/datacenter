          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">RESTART SERVICES SMS GATEWAY</h6>
            </div>
            <div class="card-body">
    ...
    <?php foreach($data as $d){ ?>
      <tr>
        ...
        <td class="text-center">
          ...
          <a class="btn btn-primary btn-xs" href="<?php echo base_url()."index.php/sms/edit_data_sms/".$d["id"]; ?>" title="Edit">
            <span class="glyphicon glyphicon-edit" aria-hidden="true"></span> Edit
          </a> ||
          <a class="btn btn-primary btn-xs" href="<?php echo base_url()."index.php/sms/do_delete_sms/".$d['id']; ?>" title="Delete" Onclick="ConfirmDelete()">
          <span class="glyphicon glyphicon-edit" aria-hidden="true"></span> Delete
          </a>
        </td>
      </tr>
    <?php } ?>
    <a class="btn btn-primary btn-xs" href="<?php echo base_url()."index.php/sms/insert_sms"; ?>"  title="Tambah">
