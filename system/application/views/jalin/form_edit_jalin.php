<html>
	...
	<body>
		...
		<form class="form-horizontal" method="POST" action="<?php echo base_url()."index.php/jalin/do_update_jalin"; ?>" class="form-horizontal">
			...
			<div class="form-group">
				<div class="col-sm-10">
				<label for="">Download Jalin start</label>
			    <input type="Time" class="form-control" id="download_jalin_start" name="download_jalin_start"  value="<?php echo $download_jalin_start; ?>" required>
			    <input type="Time" class="form-control" id="download_jalin_end" name="download_jalin_end" value="<?php echo $download_jalin_end; ?>" required>
				</div>
			</div>
			<div class="form-group">
				<div class="col-sm-10">
				<label for="">Upload Jalin</label>
			    <input type="Time" class="form-control" id="upload_jalin_start" name="upload_jalin_start" value="<?php echo $upload_jalin_start; ?>" required>
			    <input type="Time" class="form-control" id="upload_jalin_end" name="upload_jalin_end" value="<?php echo $upload_jalin_end; ?>" required>
				</div>
			</div>
			<div class="form-group">
				<div class="col-sm-10">
