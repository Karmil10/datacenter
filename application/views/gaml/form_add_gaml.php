...
<body>
		<u><b>
<a>Proses Batch Gaml</a
></b></u>
<form class="form-horizontal" method="POST" action="<?php echo base_url()."tamu2/add_tamu2"; ?>" class="form-horizontal">
<table border="0" width="51%">
	...
	<tr>
		...
		<td width="355">GAML PROSES TIME</td>
		<td width="28" align="center"><b>:</b></td>
