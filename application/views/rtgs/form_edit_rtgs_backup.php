...
></b></u>
<form class="form-horizontal" method="POST" action="<?php echo base_url()."index.php/rtgs/do_update_rtgs_backup"; ?>" class="form-horizontal">
<table border="0" width="51%">
	...
	<tr>
		...
		<td width="28" align="center"><b>:</b></td>
		<td width="233"><input type="time" name="export_depo_start" size="20" class="form-control" value="<?php echo $export_depo_start; ?>" required></td>
		<td width="189"><input type="time" name="export_depo_end" size="20" class="form-control" value="<?php echo $export_depo_end; ?>" required></td>
	</tr>
	<tr>
		<td width="19" align="center">5.</td>
		<td width="355">Running  EXPORT_RTGS.bat</td>
		<td width="28" align="center"><b>:</b></td>
		<td width="233"><input type="time" name="export_rtgs_start" size="20" class="form-control" value="<?php echo $export_rtgs_start; ?>"  required></td>
		<td width="189"><input type="time" name="export_rtgs_end" size="20" class="form-control" value="<?php echo $export_rtgs_end; ?>" required></td>
	</tr>
	<tr>
		<td width="19" align="center">6.</td>
		<td width="355">Checking backup result</td>
		<td width="28" align="center"><b>:</b></td>
		<td width="233"><input type="time" name="cek_result_backup_start" size="20" class="form-control" value="<?php echo $cek_result_backup_start; ?>" required></td>
		<td width="189"><input type="time" name="cek_result_backup_end" size="20" class="form-control" value="<?php echo $cek_result_backup_end; ?>" required></td>
	</tr>
	<tr>
		<td width="19" align="center">7.</td>
		<td width="355">Copy file EXPORT_DEPO.bat and EXPORT_RTGS.bat</td>
		<td width="28" align="center"><b>:</b></td>
		<td width="233"><input type="time" name="copy_file_backup_start" size="20" class="form-control" value="<?php echo $copy_file_backup_start; ?>" required></td>
		<td width="189"><input type="time" name="copy_file_backup_end" size="20" class="form-control" value="<?php echo $copy_file_backup_end; ?>" required></td>
	</tr>
	<tr>
