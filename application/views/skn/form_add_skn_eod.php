...
<a>END OFF DAY SKN</a
></b></u>
<form class="form-horizontal" method="POST" action="<?php echo base_url()."index.php/skn/add_data_skn_eod"; ?>" class="form-horizontal">
<table border="0" width="51%">
	...
	<tr>
		...
		<td width="28" align="center"><b>:</b></td>
		<td width="233"><input type="time" name="tutup_kredit_start" size="20" class="form-control" required></td>
		<td width="189"><input type="time" name="tutup_kredit_end" size="20" class="form-control" required></td>
	</tr>
	<tr>
		<td width="19" align="center">5.</td>
		<td width="355">Tutup Layanan Kliring Penyerahan Individual</td>
		<td width="28" align="center"><b>:</b></td>
		<td width="233"><input type="time" name="tutup_serah_start" size="20" class="form-control" required></td>
		<td width="189"><input type="time" name="tutup_serah_end" size="20" class="form-control" required></td>
	</tr>
	<tr>
		<td width="19" align="center">6.</td>
		<td width="355">Tutup Layanan Kliring Pengembalian Individual</td>
		<td width="28" align="center"><b>:</b></td>
		<td width="233"><input type="time" name="tutup_kembali_start" size="20" class="form-control" required></td>
		<td width="189"><input type="time" name="tutup_kembali_end" size="20" class="form-control" required></td>
	</tr>
	<tr>
		<td width="19" align="center">7.</td>
		<td width="355">Proses Akhir Hari</td>
		<td width="28" align="center"><b>:</b></td>
		<td width="233"><input type="time" name="proses_akhir_start" size="20" class="form-control" required></td>
		<td width="189"><input type="time" name="proses_akhir_end" size="20" class="form-control" required></td>
	</tr>
	<tr>
		<td width="19" align="center">8.</td>
		<td width="355">Proses Offline Ke SSK</td>
		<td width="28" align="center"><b>:</b></td>
		<td width="233"><input type="time" name="offline_start" size="20" class="form-control" required></td>
		<td width="189"><input type="time" name="offline_end" size="20" class="form-control"  required></td>
	</tr>
	<tr>
