...
></b></u>
<form class="form-horizontal" method="POST" action="<?php echo base_url()."index.php/skn/do_update_skn_sod"; ?>" class="form-horizontal">
<table border="0" width="51%">
	...
	<tr>
		...
		<td width="28" align="center"><b>:</b></td>
		<td width="233"><input type="time" name="sod_start" size="20" class="form-control" value="<?php echo $sod_start; ?>" required></td>
		<td width="189"><input type="time" name="sod_end" size="20" class="form-control" value="<?php echo $sod_end; ?>" required></td>
	</tr>
	<tr>
		<td width="19" align="center">5.</td>
		<td width="355">Proses Awal Hari (Kliring Kredit)</td>
		<td width="28" align="center"><b>:</b></td>
		<td width="233"><input type="time" name="kredit_start" size="20" class="form-control" value="<?php echo $kredit_start; ?>" required></td>
		<td width="189"><input type="time" name="kredit_end" size="20" class="form-control" value="<?php echo $kredit_end; ?>" required></td>
	</tr>
	<tr>
		<td width="19" align="center">6.</td>
		<td width="355">Buka Layanan Kliring Kredit Individual</td>
		<td width="28" align="center"><b>:</b></td>
		<td width="233"><input type="time" name="buka_kredit_start" size="20" class="form-control" value="<?php echo $buka_kredit_start; ?>"required></td>
		<td width="189"><input type="time" name="buka_kredit_end" size="20" class="form-control" value="<?php echo $buka_kredit_end; ?>"required></td>
	</tr>
	<tr>
		<td width="19" align="center">7.</td>
		<td width="355">Proses Awal Hari (Kliring Debet)</td>
		<td width="28" align="center"><b>:</b></td>
		<td width="233"><input type="time" name="debet_start" size="20" class="form-control" value="<?php echo $debet_start; ?>" required></td>
		<td width="189"><input type="time" name="debet_end" size="20" class="form-control" value="<?php echo $debet_end; ?>" required></td>
	</tr>
	<tr>
		<td width="19" align="center">8.</td>
		<td width="355">Buka Layanan Kliring Penyerahan Individual</td>
		<td width="28" align="center"><b>:</b></td>
		<td width="233"><input type="time" name="serah_start" size="20" class="form-control"value="<?php echo $serah_start; ?>" required></td>
		<td width="189"><input type="time" name="serah_end" size="20" class="form-control" value="<?php echo $serah_end; ?>" required></td>
	</tr>
	<tr>
		<td width="19" align="center">9.</td>
		<td width="355">Buka Layanan Kliring Pengembelian Individual</td>
		<td width="28" align="center"><b>:</b></td>
		<td width="233"><input type="time" name="beli_start" size="20" class="form-control" value="<?php echo $beli_start; ?>"required></td>
		<td width="189"><input type="time" name="beli_end" size="20" class="form-control"value="<?php echo $beli_end; ?>" required></td>
	</tr>
		<tr>
