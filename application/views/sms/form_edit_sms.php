...
<body>
		<u><b>
<a>PROSES RESTART SERVICES SMS GATEWAY</a
></b></u>
<form class="form-horizontal" method="POST" action="<?php echo base_url()."index.php/sms/do_update_sms"; ?>" class="form-horizontal">
<table border="0" width="51%">
	...
	<tr>
		...
		<td width="355">Restart Services SMS Gateway</td>
		<td width="28" align="center"><b>:</b></td>
