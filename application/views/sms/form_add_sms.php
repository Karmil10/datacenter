...
<body>
		<u><b>
<a>RESTART SERVICES SMS GATEWAY</a
></b></u>
<form class="form-horizontal" method="POST" action="<?php echo base_url()."index.php/sms/add_data_sms"; ?>" class="form-horizontal">
<table border="0" width="51%">
	...
	<tr>
		...
		<td width="355">Restart Sms Gateway Proses Time</td>
		<td width="28" align="center"><b>:</b></td>
