<table border="0" width="44%" height="456" align="center">
	<tr>
		...
		<table border="1" width="100%" height="480" style="border-width: 0px">
			...
			<tr>
				<td width="23%" style="border-style: none; border-width: medium">No. Visitor / NIK</td>
			...
			<tr>
				<td width="23%" style="border-style: none; border-width: medium">Remaks</td>
			...
			<tr>
				<td width="23%" style="border-style: none; border-width: medium"><label for="exampleFormControlInput1">Jam</label></td>
				<td width="2%" align="center" style="border-style: none; border-width: medium"><b>:</b></td>
				<td width="71%" style="border-style: none; border-width: medium">
   ...
   4. Login melalui Intranet dengan Login User yang sudah ada.
			...
			<tr>
				<td width="23%" style="border-style: none; border-width: medium"><label for="exampleFormControlInput1"></label></td>
				<td width="2%" align="center" style="border-style: none; border-width: medium"><b></b></td>
...
function myFunction() {
  ...
  setTimeout(function(){ window.location="view_tt";});
}
</script>

			<p><button type="submit" class="btn btn-primary" onclick="myFunction()"></i>Simpan</button>
	...
	<script type="text/javascript">
		$('#register').on('submit', function (event) {
			...
			$.ajax({
				...
				type: 'POST',
				dataType: 'json',
				data: {code: code, id: id, nama: nama, departemen: departemen, keperluan: keperluan, tanggal: tanggal, jam: jam, jam1: jam1, remaks: remaks, check_list:check_list, image:image},
			})
			.done(function(data) {
				if (data >= 0) {
