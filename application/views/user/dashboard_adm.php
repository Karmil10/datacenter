                ...
                <?php 
                  ...
                  <tr>
                        ...
                        if ($ij->status == 1 ) {  ?>
                          ...
                          <td><a href="<?= base_url('user/adm/approved/'.$ij->id_ijin,) ?>" class="btn btn-sm btn-danger btn-lg " role="button" aria-pressed="true">Belum Di Approved</a></td>

                               <?php } else { ?>
                               


                         <td><a href="#" class="btn btn-sm btn-success btn-lg disabled" role="button" aria-disabled="true">Approved</a></td>
                      ...
                      <td><?php echo anchor('user/adm/detail/'.$ij->id_ijin,'<div class="btn btn-success btn-sm"><i class="fa fa-search-plus"></i></div>') ?></td>
