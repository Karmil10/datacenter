...
></b></u>
<form class="form-horizontal" method="POST" action="<?php echo base_url()."index.php/ej/do_update_ej"; ?>" class="form-horizontal">
<table border="0" width="51%">
	...
	<tr>
		...
		<td width="28" align="center"><b>:</b></td>
		<td width="233"><input type="time" name="copy_dataej_start" size="20" class="form-control" value="<?php echo $copy_dataej_start; ?>"required></td>
		<td width="189"><input type="time" name="copy_dataej_end" size="20" class="form-control" value="<?php echo $copy_dataej_end; ?>" required></td>
	</tr>
	<tr>
