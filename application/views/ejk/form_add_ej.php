...
<body>
		<u><b>
<a>PROSES DOWNLOAD & COPY EJOURNAL</a
></b></u>
<form class="form-horizontal" method="POST" action="<?php echo base_url()."index.php/ej/add_data_ej"; ?>" class="form-horizontal">
<table border="0" width="51%">
	...
	<tr>
		...
		<td width="355">Proses Download EJournal</td>
		<td width="28" align="center"><b>:</b></td>
		<td width="233"><input type="time" name="start_time" size="20" class="form-control" required></td>
		<td width="189"><input type="time" name="end_time" size="20" class="form-control" required></td>
	</tr>
	<tr>
		<td width="19" align="center">5.</td>
		<td width="355">Proses Copy Data EJournal</td>
		<td width="28" align="center"><b>:</b></td>
		<td width="233"><input type="time" name="copy_dataej_start" size="20" class="form-control" required></td>
		<td width="189"><input type="time" name="copy_dataej_end" size="20" class="form-control" required></td>
	</tr>
	<tr>
