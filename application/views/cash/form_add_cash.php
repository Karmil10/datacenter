...
></b></u>
<form class="form-horizontal" method="POST" action="<?php echo base_url()."index.php/cash/add_data_cash"; ?>" class="form-horizontal">
<table border="0" width="51%">
	...
	<tr>
		...
		<td width="28" align="center"><b>:</b></td>
		<td width="233"><input type="time" name="copy_datacash_start" size="20" class="form-control" required></td>
		<td width="189"><input type="time" name="copy_datacash_end" size="20" class="form-control" required></td>
	</tr>
	<tr>
