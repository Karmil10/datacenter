    ...
    <?php foreach($data as $d){ ?>
      <tr>
        ...
        <td class="text-center">
          ...
          <a class="btn btn-primary btn-xs" href="<?php echo base_url()."index.php/ej/edit_data_ej/".$d["id"]; ?>" title="Edit">
            <span class="glyphicon glyphicon-edit" aria-hidden="true"></span> Edit
          </a> ||
          <a class="btn btn-primary btn-xs" href="<?php echo base_url()."index.php/ej/do_delete_ej/".$d['id']; ?>" title="Delete" Onclick="ConfirmDelete()">
          <span class="glyphicon glyphicon-edit" aria-hidden="true"></span> Delete
          </a>
        </td>
      </tr>
    <?php } ?>
    <a class="btn btn-primary btn-xs" href="<?php echo base_url()."index.php/ej/insert_ej"; ?>"  title="Tambah">
